...
#define DEFINE_TRANSFORM_INV_V_INV_P_LVP_SHADER_CONSTANT_(NAME, index)\
	CBuffer NAME RegisterB(index)\
	{\
		float4x4 invV;\
		float4x4 invP;\
...
#define Define_Transform_InvV_InvP_LVP_HLSL(index)\
	DEFINE_TRANSFORM_INV_V_INV_P_LVP_SHADER_CONSTANT_(TRANSFORM_CONSTANT_BUFFER_NAME, index)
...
#define DEFINE_SHADER_CONSTANT_C(DUMMY)\
	...
	DEFINE_TRANSFORM_INV_V_INV_P_LVP_SHADER_CONSTANT_(Transform_InvV_InvP_LVP)\
